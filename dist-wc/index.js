...
function StkPagination(_a) {
    ...
    return (e$1(d$1, { children: e$1("nav", __assign({ className: "stk-pagination" }, { children: [hasPreviousPage ? (e$1("button", __assign({ onClick: function () { return handlePageChange(currentPage - 1); }, className: classNames('stk-pagination__button', 'stk-pagination__button--prev', 'stk-pagination__button--first') }, { children: "Previous" }), void 0)) : (e$1("span", __assign({ className: classNames('stk-pagination__button', 'stk-pagination__button--prev', 'stk-pagination__button--first', 'stk-pagination__button--disabled') }, { children: "Previous" }), void 0)), pages.map(function (page, index) { return (e$1(d$1, { children: page.number ? (e$1("button", __assign({ onClick: function () { return handlePageChange(page.number); }, className: classNames('stk-pagination__button', {
                        ...
                        }) }, { children: page.number }), index)) : (e$1("span", __assign({ className: "stk-pagination__separator" }, { children: "\u2026" }), void 0)) }, page)); }), hasNextPage ? (e$1("button", __assign({ onClick: function () { return handlePageChange(currentPage + 1); }, className: classNames('stk-pagination__button', 'stk-pagination__button--next', 'stk-pagination__button--last') }, { children: "Next" }), void 0)) : (e$1("span", __assign({ className: classNames('stk-pagination__button', 'stk-pagination__button--next', 'stk-pagination__button--last', 'stk-pagination__button--disabled') }, { children: "Next" }), void 0))] }), void 0) }, void 0));
}
...
function StkPaginationWC(_a) {
    ...
    return (e$1(StkPagination, { ref: ref, currentPage: parseNumberProp(currentPage), totalPages: parseNumberProp(totalPages), onPageChange: pageChange }, void 0));
}
